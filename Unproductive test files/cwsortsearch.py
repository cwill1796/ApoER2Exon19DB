...
print("""
       ...
       <div class="twelve columns center">
        ...
        <div class="twelve columns center">
            <form name="Search Order" action="https://bioed.bu.edu/cgi-bin/students_20/groupG/cwsortsearch.py" method="post">
...
if form:
    ...
    if results:
        ...
        if form.getvalue('search_box_1'):
            datat += 'Results of search:",{dropdown12},{search_box_12},'.format(dropdown12=dropdown1,search_box_12=search_box_1)
        if form.getvalue('search_box_2'):
